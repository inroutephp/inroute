...
interface PluginInterface extends LoggerAwareInterface
{
     ...
     *
     * At compile time each found route definition is processed by registered
     * plugins. Plugins can read annotations, alter the definition of the route
     * and register pre and post filters.
     *
